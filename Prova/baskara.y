...
;
Conteudo:
	|T_VIRGULA T_VARIAVEL T_DOISPONTOS T_INTEIRO Conteudo
	|T_VIRGULA T_VARIAVEL T_DOISPONTOS T_INTEIRO T_DOISPONTOS T_INTEIRO Conteudo
;
Escreva:
	T_ESCREVA T_ABRE_PARENT T_STRING T_FECHA_PARENT 
;

Escreval:
	Escreva
	|T_ESCREVAL T_ABRE_PARENT T_STRING Conteudo T_FECHA_PARENT 
;
